...
import in.bharatrohan.br_fe_uav.Adapters.LandRecyclerAdapter;
        ...
        call.enqueue(new retrofit2.Callback<Farmer>() {
            ...
            public void onResponse(Call<Farmer> call, Response<Farmer> response) {
                ...
                if (response.code() == 200) {
                    ...
                    new PrefManager(FarmerFarms.this).saveUserDetails("", "", "", "", false, "", "", "", "", "", "");
                    new PrefManager(FarmerFarms.this).saveUserType("");
